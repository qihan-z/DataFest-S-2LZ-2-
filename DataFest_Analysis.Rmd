...
ggplot(data = US18, aes(x = factor(DEM_EDU), fill = factor(HELP_SUB_USE)))+
  ...
  labs(y = "Proportion", 
       ...
       title = "Proportion of people who have sought professional help \nfor substance abuse by education level")
```
...
scale_x_discrete(labels=c("0" = "Public",
  ...
  labs(y = "Proportion", 
       x = "College Type", 
       fill = "Whether seek help",
       title = "Proportion of college students who have sought professional help \nfor substance abuse by college type")
```
...
ggplot(data = students_US, aes(x = factor(COLLEGE_SIZE), fill = factor(HELP_SUB_USE)))+
  ...
  labs(y = "Proportion", 
       x = "College size", 
       fill = "Whether seek help",
       title = "Proportion of college students who have sought professional help \nfor substance abuse by college size")
```
...
ggplot(data = students_US, aes(x = factor(COLLEGE_LENGTH), fill = factor(HELP_SUB_USE)))+
  ...
  labs(y = "Proportion", 
       x = "College length", 
       fill = "Whether seek help",
       title = "Proportion of college students who have sought professional help \nfor substance abuse by college length")
```
...
ggplot(data = students_US, aes(x = factor(COLLEGE_GREEK), fill = factor(HELP_SUB_USE)))+
  ...
  labs(y = "Proportion", 
       x = "Are You A Member of A College Greeklife Organization", 
       fill = "Whether seek help",
       title = "Proportion of college students who have sought professional help \nfor substance abuse by Greek Life")
...
ggplot(data = US18, aes(x = factor(COLLEGE_GREEK), fill = factor(HPC_USE)))+
 ...
 labs(y = "Proportion", 
      ...
      fill = "Know a Healthcare Collegue that Intended to Misuse", 
       title = "Proportion of Greeklife Students that Know a Healthcare Collegue Intending to Misuse")
```
...
ggplot(data = US18, aes(x = factor(COLLEGE_GREEK), fill = factor(HPC_SELL)))+
 ...
 labs(y = "Proportion", 
      ...
      fill = "Know a Healthcare Collegue that Intended to Sell", 
       title = "Proportion of Greeklife Students that Know a Healthcare Collegue Intending to Sell")
```
